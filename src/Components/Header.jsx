...
const Header = () => {
  return (
    <>
      <div>
        <header>
          <nav className=" border-gray-200 px-4 lg:px-6 py-2.5  bg-header-color">
              ...
              >
                <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                  <li>
                    <a
                      href="#"
                      className="block py-2 pr-4 pl-3 lg:dark:hover:text-white   dark:text-gray-400 rounded  lg:bg-transparent  lg:p-0 "
                      aria-current="page"
                    >
                      About Us
                    </a>
